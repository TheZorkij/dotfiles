...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(mocha editorconfig
rjsx-mode)
...
(defun dotspacemacs/user-config ()
  (define-key evil-normal-state-map (kbd "SPC RET") 'my-mocha)
